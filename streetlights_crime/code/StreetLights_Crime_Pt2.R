...
Summary.Table.Alley  <- data.frame(matrix(ncol = 4, nrow = 10), row.names = c("All Crimes", 
                                                                              "Thefts", "Narcotics", "Battery", "Criminal Damage", 
                                                                              "Motor Vehicle Theft", "Robbery", "Assault", "Burglary", "Homicide"))
Summary.Table.OneOut <- data.frame(matrix(ncol = 4, nrow = 10), row.names = c("All Crimes", 
                                                                              "Thefts", "Narcotics", "Battery", "Criminal Damage", 
                                                                              "Motor Vehicle Theft", "Robbery", "Assault", "Burglary", "Homicide"))
Summary.Table.AllOut <- data.frame(matrix(ncol = 4, nrow = 10), row.names = c("All Crimes", 
                                                                              "Thefts", "Narcotics", "Battery", "Criminal Damage", 
                                                                              "Motor Vehicle Theft", "Robbery", "Assault", "Burglary", "Homicide"))
...
Summary.Table.Alley$LL <- numeric(10)
Summary.Table.Alley$UL <- numeric(10)
Summary.Table.Alley$p.value <- numeric(10)
Summary.Table.Alley$star <- character(10)
...
Summary.Table.OneOut$LL <- numeric(10)
Summary.Table.OneOut$UL <- numeric(10)
Summary.Table.OneOut$p.value <- numeric(10)
Summary.Table.OneOut$star <- character(10)
...
Summary.Table.AllOut$LL <- numeric(10)
Summary.Table.AllOut$UL <- numeric(10)
Summary.Table.AllOut$p.value <- numeric(10)
Summary.Table.AllOut$star <- character(10)
